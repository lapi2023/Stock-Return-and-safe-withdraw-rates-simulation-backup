...
def calculate_return_monthly_buy_and_sell_on_target_return_single_try(sheet_tuple, annualized_return_threshold_low,
                                                                      annualized_return_threshold_high, startdate,
                                                                      invest_years, monthly_income,
                                                                      min_invest_months=12, inflation_rate=0):
    ...
    while utils.canbe_simulated_monthly(sheet_tuple, current_month, 1) and elapsed_months / 12 < invest_years:
        ...
        if (invested_months <= min_invest_months) or (
                annualized_return_threshold_low < asset_return < annualized_return_threshold_high):
...
def calculate_return_monthly_buy_and_sell_on_target_return_iterate(ticker, annualized_return_threshold_low,
                                                                   annualized_return_threshold_high,
                                                                   startdate: datetime, enddate: datetime, invest_years,
                                                                   monthly_income, min_invest_months=12,
    ...
    while utils.canbe_simulated_yearly(sheet_tuple, current_date, invest_years) and (
        ...
        invested_amount, returned_asset, wallet, sold_count, elapsed_months = \
            calculate_return_monthly_buy_and_sell_on_target_return_single_try(
                sheet_tuple, annualized_return_threshold_low, annualized_return_threshold_high, current_date,
                invest_years,
...
def generate_dumpfiles_monthly_buy_and_sell_on_target_return(
        ticker, annualized_return_threshold_low, annualized_return_threshold_high, startdate: datetime, enddate,
        invest_years, monthly_income, min_invest_months,
    ...
    asset_result_list, asset_list, sold_count_list = \
        calculate_return_monthly_buy_and_sell_on_target_return_iterate(
            ticker, annualized_return_threshold_low, annualized_return_threshold_high, startdate, enddate, invest_years,
            monthly_income, min_invest_months, inflation_rate, asset_log_dir
        )
            ...
            for target_annualized_return_threshold_high in target_annualized_return_threshold_high_list:
                ...
                for invest_years in tqdm.tqdm([30],
                    ...
                    generate_dumpfiles_monthly_buy_and_sell_on_target_return(
                        ticker, target_annualized_return_threshold_low, target_annualized_return_threshold_high,
                        startdate, enddate, invest_years, monthly_income, min_invest_months, inflation_rate,
