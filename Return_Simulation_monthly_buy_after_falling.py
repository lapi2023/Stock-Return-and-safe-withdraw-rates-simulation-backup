...
def calculate_return_monthly_buy_after_falling_single_try(sheet_tuple, change_rate_threshold_low, change_rate_threshold_high, startdate, invest_years, monthly_income, inflation_rate=0):
...
def calculate_return_monthly_buy_after_falling_iterate(ticker, change_rate_threshold_low, change_rate_threshold_high, startdate: datetime, enddate: datetime, invest_years, monthly_income, inflation_rate=0, asset_log_dir =""):
    """
...
def generate_dumpfiles_monthly_buy_after_selling(
        ticker, change_rate_threshold_low, change_rate_threshold_high, startdate: datetime, enddate, invest_years, monthly_income,
    ...
    asset_result_list, asset_list, invested_amount_list, invested_months_list, sold_count_list = \
        ...
        ticker, change_rate_threshold_low, change_rate_threshold_high, startdate, enddate, invest_years, monthly_income, inflation_rate, asset_log_dir
        )
        ...
        for change_rate_threshold_low in change_rate_threshold_low_list:
            for change_rate_threshold_high in change_rate_threshold_high_list:
                ...
                for invest_years in tqdm.tqdm([30],
                                                  desc=f"{ticker}, change rate{change_rate_threshold_low:.0%} - {change_rate_threshold_high:.0%}"):
                    generate_dumpfiles_monthly_buy_after_selling(
                        ticker, change_rate_threshold_low, change_rate_threshold_high, startdate, enddate, invest_years, monthly_income, inflation_rate,
