...
if __name__ == '__main__':
    ...
    if not os.path.exists(out_dir):
        os.makedirs(out_dir)
    SPX_1year_dic = load_dump("Return_Simulation\dump\SPX100_1years_inflation_2percent_dump\\", "asset_result_list", "price_growth_rate_list")
    SPX_5years_dic = load_dump("Return_Simulation\dump\SPX100_5years_inflation_2percent_dump\\", "asset_result_list", "price_growth_rate_list")
    SPX_10years_dic = load_dump("Return_Simulation\dump\SPX100_10years_inflation_2percent_dump\\", "asset_result_list", "price_growth_rate_list")
    SPX_20years_dic = load_dump("Return_Simulation\dump\SPX100_20years_inflation_2percent_dump\\", "asset_result_list", "price_growth_rate_list")
    SPX_30years_dic = load_dump("Return_Simulation\dump\SPX100_30years_inflation_2percent_dump\\", "asset_result_list", "price_growth_rate_list")
    SPX_40years_dic = load_dump("Return_Simulation\dump\SPX100_40years_inflation_2percent_dump\\", "asset_result_list", "price_growth_rate_list")
    SPX_50years_dic = load_dump("Return_Simulation\dump\SPX100_50years_inflation_2percent_dump\\", "asset_result_list", "price_growth_rate_list")
