...
def load_dump(dump_dir, *args):
    ...
    for filename in args:
        if (os.path.isfile(dump_dir + filename + ".dump")):
            ...
            loaded_dic[filename] = []
    return loaded_dic
def simulate_once_a_year_two_assets_single_with_rebalancing(sheet1, percentage1, sheet2, percentage2, startdate: datetime, withdraw_years,
...
def simulate_once_a_year_two_assets_multi(sheet1, percentage1, sheet2, percentage2, startdate: datetime,
    ...
    while canbe_simulated(sheet1, current_date, withdraw_years) and (current_date < enddate):
        ...
        asset_final, final_asset1, final_asset2, simulated_years = simulate_once_a_year_two_assets_single_with_rebalancing(sheet1,
                                                                                                          percentage1,
                                                                                                          sheet2,
                                                                                                          percentage2,
                                                                                                          current_date,
